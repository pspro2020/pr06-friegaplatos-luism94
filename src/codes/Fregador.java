...
public class Fregador implements Runnable {
	...
	public Fregador(Bandeja bandeja, DateTimeFormatter formatoHora) {
	...
	public void run() {
		...
		while (!Thread.currentThread().isInterrupted()) {
			...
			try {
				//El hilo coloca el plato en la bandeja de platos limpios para el siguiente hilo
				bandeja.colocarEnBandejaLimpios(plato);
			} catch(InterruptedException e) {
